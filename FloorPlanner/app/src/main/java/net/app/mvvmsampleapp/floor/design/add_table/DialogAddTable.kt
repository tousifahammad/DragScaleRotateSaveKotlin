...
class DialogAddTable(
    ...
    private var default_table_width = 160
    private var default_table_height = 160
        ...
        btn_add?.setOnClickListener {
            if (validateEveryField()) {
                if (table_id.isEmpty()) { //create
                    //addTableToDB()
                    tableRepository.addTableToDB(
                        et_table_name?.text.toString(),
                        table_type,
                        default_table_width + table_size,
                        default_table_height + table_size,
                        0f,
                        0f,
                        0f
                    )
